...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        sys.exit()
    if sys.argv[1] == '1':
        run([('AC','0?','0?'),('BD','0?','0?'),('--','??','00'),('--','00','??'),('AB','00','00')], '1.1')
        run([('AC','00','01'),('BD','01','00'),('--','??','00'),('--','00','??'),('AB','00','00')], '1.2')
        run([('AC','00','01'), ('BD','01','00'), ('AD','01','00'), ('BC','00','01'), ('AB','00','00')], '1.3')
        run([('12',), ('13',), ('13',), ('12',), ('11',)], '1.4')
        run([('AC','00','01'), ('BD','01','00'), ('DA','10','00'), ('BC','00','01'), ('AB','00','00')], '1.5')
        run([('12',), ('13',), ('31',), ('12',), ('11',)], '1.6')
